...
test("valid userName and password test", async function ({ browser }) {
    ...
    // below condition, I have put becuase if I dont put this here, the line number 22 retrun the empty Array of list, you cab remove the below line and see the outcome.
