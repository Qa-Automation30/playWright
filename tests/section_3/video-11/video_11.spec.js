...
// What does the mean of above statement : it means that -> the timeout for all assertions would be 10 seconds. 
//and it is declared in "playWright.config.js" file.
...
test("second test", async function({browser}){
    ...
    * and once you find the selector on the page then you need to send the some value in the text box, so how you will do it.
