...
test('Locators', async ({ browser }) => {
    ...
    // this is the one way to validate that logout button is visible or not-->
    //when you check the documentation for "toBeVisible()" method, it will return void.
    ...
    // in this case it will return more than one element --> 
    //so there is another way to write the locator which return multiple elements->
